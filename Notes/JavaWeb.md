...
- `JavaEE`项目的三层框架
  ...
  ![image-20210418124703440](JavaWeb/002.png)
...
- 开发代码角度开发流程
  ...
  1. 实现用户注册的功能
     ...
     ![image-20210419195256837](JavaWeb/003.png)
...
2. ### `jsp`语法
   ...
   - `servlet` + `jsp` 整个流程
     ...
     ![image-20210420193324931](JavaWeb/004.png)
...
- 标签库
  ...
  ![image-20210421160748462](C:/Users/ASUS/AppData/Roaming/Typora/typora-user-images/image-20210421160748462.png)![005](JavaWeb/005.png)
...
- 文件的下载
  ...
  ![image-20210422184135042](JavaWeb/006.png)
