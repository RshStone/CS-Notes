...
Java 简史  Java 一开始就是用在Web上的嘛？图样图simple。 最初叫Oak，目的是干嘛？用在小型家电设备的嵌入式应用。结果市场没反响，最后互联网崛起让Oak焕发了生机。
...
https://www.haskell.org/#step17

书籍：Modern_Java_in_Action,_2nd_Ed
...
https://www.youtube.com/watch?v=mUWGDW4ly1I
...
```html
Error: Could not find or load main class RegexTestHarness
Caused by: java.lang.NoClassDefFoundError: src/RegexTestHarness (wrong name: RegexTestHarness)
```

https://stackoverflow.com/questions/29226743/solving-the-no-console-error
